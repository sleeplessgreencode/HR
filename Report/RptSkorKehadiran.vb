...
Public Class RptSkorKehadiran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_ASPNET.RptSkorKehadiran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSkorKehadiran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSkorKehadiran = New RptSkorKehadiran()
        rpt.Site = Me.Site
        Return rpt
    End Function
