...
Public Class RptRekapAbsensi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_ASPNET.RptRekapAbsensi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRekapAbsensi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRekapAbsensi = New RptRekapAbsensi()
        rpt.Site = Me.Site
        Return rpt
    End Function
